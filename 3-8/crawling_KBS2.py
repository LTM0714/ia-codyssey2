from selenium import webdriver # Selenium 라이브러리에서 웹 드라이버를 제어하기 위한 모듈 임포트
from selenium.webdriver.chrome.service import Service # ChromeDriver의 서비스 객체를 생성하기 위한 모듈 임포트
from webdriver_manager.chrome import ChromeDriverManager # ChromeDriver의 버전 관리를 자동으로 해주는 라이브러리 임포트
from selenium.webdriver.common.by import By # 웹 요소를 찾기 위한 다양한 방법을 제공하는 모듈 임포트
from selenium.webdriver import ActionChains, Keys
import pyperclip # 클립보드 복사/붙여넣기 기능을 제공하는 라이브러리 임포트
import time
import os
...
def main(user_id, user_pw):
    ...
    actions = ActionChains(driver) # ActionChains를 이용해 Ctrl+V 동작 수행
